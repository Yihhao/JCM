...
include 'C:/Users/Yihao/Documents/anaconda3/envs/qinfo/lib/site-packages/qutip/cy/complex_math.pxi'
...
def cy_td_ode_rhs(
    ...
    spmvpy(&data1[0], &idx1[0], &ptr1[0], &vec[0], (0 if (t > 13.000000) else _td_array_0[int(round(299 * (t/13.000000)))]), out, num_rows)
